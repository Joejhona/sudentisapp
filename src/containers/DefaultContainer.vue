<template>
  <div class="app">
    <AppHeader fixed>
      <SidebarToggler v-if="isAuthenticated" class="d-lg-none" display="md" mobile />
      <b-link class="navbar-brand" to="#">
        <img class="navbar-brand-full" src="img/brand/logo.svg" width="89" height="25" alt="CoreUI Logo">
        <img class="navbar-brand-minimized" src="img/brand/sygnet.svg" width="30" height="30" alt="CoreUI Logo">
      </b-link>
      <SidebarToggler v-if="isAuthenticated" class="d-md-down-none" display="lg" />
      <b-navbar-nav v-if="isAuthenticated" class="d-md-down-none">
      ...
      <AsideToggler v-if="isAuthenticated" class="d-none d-lg-block" />
      <AsideToggler v-if="isAuthenticated" class="d-lg-none" mobile />
    </AppHeader>
    <div class="app-body">
      <AppSidebar fixed>
        <SidebarHeader/>
        <SidebarForm/>
        <SidebarNav v-if="isAuthenticated" :navItems="nav"></SidebarNav>
        <SidebarFooter/>
        <SidebarMinimizer/>
      </AppSidebar>
      <main class="main">
